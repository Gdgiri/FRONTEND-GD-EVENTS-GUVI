                  ...
                  <table className="table table-borderless m-3">
                    <tbody>
                      <tr>
                        ...
                        <td>Price: {event.cateringAmount}</td>
                      </tr>
                      <tr>
                        <td>Photographer: {event.photographerName}</td>
                        <td>Price: {event.photographerAmount}</td>
                      </tr>
                      <tr>
                        <td>EventStylist: {event.eventStylistName}</td>
                        <td>Price: {event.eventStylistAmount}</td>
                      </tr>
                      <tr>
                        <td>Entertainer: {event.entertainerName}</td>
                        <td>Price: {event.entertainerAmount}</td>
                      </tr>
                      <tr>
                        <td>Beautician: {event.beauticianName}</td>
                        <td>Price: {event.beauticianAmount}</td>
                      </tr>
                      <tr>
                        <td>Transport {event.transportName}</td>
                        <td>Price: {event.transportAmount}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
